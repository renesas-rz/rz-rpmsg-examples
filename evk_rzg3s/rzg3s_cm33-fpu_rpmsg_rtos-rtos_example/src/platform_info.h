...
#ifdef __linux__
 #define MBX_REG_BASE    0x10400000
#else
...
/*
 * If you want to do Cortex-M33 as slave and Cortex-M33_FPU as master,
 * you need to set CM33_IS_SLAVE to 1.
 */
#define CM33_IS_SLAVE   (0U)

#ifdef __linux__
 #define MBX_INT_NUM     58            // RSP0_NS_IRQn
#else
#ifdef RPM_TO_CA55
 #define MBX_INT_NUM     58            // MSG0_NS_IRQn
#else
 #if (CM33_IS_SLAVE == 0)
  #define MBX_INT_NUM     61           // MSG5_NS_IRQn
 #else
  #define MBX_INT_NUM     60           // RSP3_NS_IRQn
 #endif
#endif
#endif
...
/*
 * If you want to support remoteproc framework to load CM33 FW,
...
extern TaskHandle_t CA55_task_id;
extern TaskHandle_t *task_id;
