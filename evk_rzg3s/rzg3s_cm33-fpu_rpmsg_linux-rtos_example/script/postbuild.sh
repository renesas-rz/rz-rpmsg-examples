...
arm-none-eabi-objcopy -O binary ${filebody}.elf -R .resource_table -R .rodata.bootparam ${filebody}.bin
arm-none-eabi-objcopy -I binary -O srec --srec-forceS3 --adjust-vma 0x80200000 ${filebody}.bin ${filebody}.srec
arm-none-eabi-objcopy -O binary ${filebody}.elf -R .resource_table ${filebody}.bin
