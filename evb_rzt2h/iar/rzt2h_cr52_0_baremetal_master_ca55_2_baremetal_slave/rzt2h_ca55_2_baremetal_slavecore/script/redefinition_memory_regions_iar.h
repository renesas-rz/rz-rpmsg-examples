...
define symbol OPENAMP_RSCTBL_START_ADDRESS  = 0xE0000000;
define symbol OPENAMP_RSCTBL_LENGTH_ADDRESS = 0x00001000;
define symbol INTERCPU_SHM_START_ADDRESS    = 0xE0001000;
define symbol INTERCPU_SHM_LENGTH_ADDRESS   = 0x00001000;
define symbol OPENAMP_VRING_START_ADDRESS   = 0xE1000000;
...
if (isdefinedsymbol(INTERCPU_SHM_START_ADDRESS))
{
    define symbol INTERCPU_SHM_START              = INTERCPU_SHM_START_ADDRESS;
    define symbol INTERCPU_SHM_END_ADDRESS_OFFSET = 1;
}
else
{
    define symbol INTERCPU_SHM_START              = 0;
    define symbol INTERCPU_SHM_END_ADDRESS_OFFSET = 0;
}

if (isdefinedsymbol(INTERCPU_SHM_LENGTH_ADDRESS))
{
    define symbol INTERCPU_SHM_LENGTH	= INTERCPU_SHM_LENGTH_ADDRESS;
}
else
{
    define symbol INTERCPU_SHM_LENGTH	= 0;
}
