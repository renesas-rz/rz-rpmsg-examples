...
#include <RM_OpenAMP_App/OpenAMP_RPMsg_cfg.h>
#include "bsp_api.h"
...
#define SHM_DEV_NAME    "0xE0001000.intercpu-shm"
...
#define MBX_TX_CH    (0x1U)            /* Maibox TX channel (0, 1, ..., or 15 this program uses */
#define MBX_RX_CH    (0x0U)            /* Maibox RX channel (0, 1, ..., or 15 this program uses */
...
/**
 * platform_get_notification - platform get notification
 *
 * @platform: pointer to the platform
 *
 * return negative value for errors, otherwise 0.
 */
int platform_get_notification(void * priv);
