        ...
        #define VECTOR_NUMBER_SCI5_ERI ((IRQn_Type) 610) /* SCI5_ERI (SCI5 Receive error) */
        #define VECTOR_NUMBER_SCI5_RXI ((IRQn_Type) 611) /* SCI5_RXI (SCI5 Receive data full) */
        #define VECTOR_NUMBER_SCI5_TXI ((IRQn_Type) 612) /* SCI5_TXI (SCI5 Transmit data empty) */
        #define VECTOR_NUMBER_SCI5_TEI ((IRQn_Type) 613) /* SCI5_TEI (SCI5 Transmit end) */
        typedef enum IRQn {
            ...
            SCI5_ERI_IRQn = 610, /* SCI5_ERI (SCI5 Receive error) */
            SCI5_RXI_IRQn = 611, /* SCI5_RXI (SCI5 Receive data full) */
            SCI5_TXI_IRQn = 612, /* SCI5_TXI (SCI5 Transmit data empty) */
            SCI5_TEI_IRQn = 613, /* SCI5_TEI (SCI5 Transmit end) */
