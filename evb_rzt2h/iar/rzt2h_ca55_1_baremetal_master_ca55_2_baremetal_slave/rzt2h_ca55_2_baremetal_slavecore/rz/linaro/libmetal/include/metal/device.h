...
struct metal_bus_ops
{
    ...
    int  (* dev_dma_map)(struct metal_bus * bus, struct metal_device * device, uint32_t dir, struct metal_sg * sg_in,
                         int nents_in, struct metal_sg * sg_out);
    void (* dev_dma_unmap)(struct metal_bus * bus, struct metal_device * device, uint32_t dir, struct metal_sg * sg,
                           int nents);
};
...
extern int metal_generic_dev_open(struct metal_bus * bus, const char * dev_name, struct metal_device ** device);
