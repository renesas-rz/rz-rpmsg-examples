...
#define CFG_RSCTBL_DEV_NAME      "E0000000.rsctbl"
#define CFG_RSCTBL_MEM_VA        (0xE0000000)
#define CFG_RSCTBL_MEM_PA        (0xE0000000)
#define CFG_RSCTBL_MAP_SIZE      (0x00000100U) // 4KB
