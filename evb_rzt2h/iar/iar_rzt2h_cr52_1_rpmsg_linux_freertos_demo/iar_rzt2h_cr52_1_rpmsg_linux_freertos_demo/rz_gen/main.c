...
#include "bsp_api.h"
                ...
                #if defined(BSP_MCU_GROUP_RZN2H) || defined(BSP_MCU_GROUP_RZN2L) || \
                    defined(BSP_MCU_GROUP_RZT2H) || defined(BSP_MCU_GROUP_RZT2M) || defined(BSP_MCU_GROUP_RZT2ME) || defined(BSP_MCU_GROUP_RZT2L)
                /* Not used */
                #else
                /* Initialize heap memories */
                ...
                **********************************************************************************************************************/
                ...
                static inline void _IOW32(uintptr_t adr, uint32_t data)
                {
                    *(volatile uint32_t*)adr = data;
                }

                static inline uint32_t _IOR32(uintptr_t adr)
                {
                ...
                int main(void)
                {
                    ...
                    /* Not used */
                    #else
                    /* Define Heap reagion (this is used only heap_5.c is used) */
