...
/* Resource table UIO device */
 ...
 #define CFG_RSCTBL_MEM_VA       (0xE0000000U)
 #define CFG_RSCTBL_MEM_PA       (0xE0000000U)
#elif defined(BSP_CFG_CORE_CA55)
 #define CFG_RSCTBL_DEV_NAME     "206000000.rsctbl"
 #define CFG_RSCTBL_MEM_VA       (0xC6000000U)
 ...
 * so the definition of fw_rsc_vdev must be overridden.
 */
