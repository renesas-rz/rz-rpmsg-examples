...
#define MBX_REG_PA       0x802A0000
#define MBX_REG_VA       0x802A0000
#define MBX_MAP_SIZE     0x00000000

#if defined(BSP_CFG_CORE_CR52)
 #define MBX_MAP_DDR     0xE0000000
#elif defined(BSP_CFG_CORE_CA55)
 #define MBX_MAP_DDR     0xC0000000
#endif

#define MBX_INT_NUM      1
...
// Shared memory config
 ...
 #define SHM_DEV_BASE    0xE0001000
#elif defined(BSP_CFG_CORE_CA55)
 #define SHM_DEV_NAME    "206001000.intercpu-shm"
 #define SHM_DEV_BASE    0xC6001000
#endif
...
#define MBX_TX_CH    (0x1U)            /* Mailbox TX channel (0, 1, ..., or 15 this program uses */
#define MBX_RX_CH    (0x0U)            /* Mailbox RX channel (0, 1, ..., or 15 this program uses */
...
/*
 * If you want to support remoteproc framework to load CR52 FW,
 * you need to set ENABLE_REMOTEPROC to 1.
 */
#define ENABLE_REMOTEPROC    (0U)

/*
 * If you want to support BL2 boot of CA55,
 * you need to set ENABLE_BL2 to 1.
 */
#define ENABLE_BL2           (0U)

// Page size on Linux (Default: 4KB)
#define PAGE_SIZE            (0x01000U) // 4KB page size as the default value

// Mailbox config
#define MBX_DEV_NAME         "0x802A0000.mbox-uio"
#define MBX_NO               (0x0U)     /* Mailbox number (0, 1, ..., or 7) this program uses */
