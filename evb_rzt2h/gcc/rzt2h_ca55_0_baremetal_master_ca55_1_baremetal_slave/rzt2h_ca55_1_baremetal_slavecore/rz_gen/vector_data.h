        ...
        #define VECTOR_NUMBER_SCI0_ERI ((IRQn_Type) 590) /* SCI0_ERI (SCI0 Receive error) */
        #define VECTOR_NUMBER_SCI0_RXI ((IRQn_Type) 591) /* SCI0_RXI (SCI0 Receive data full) */
        #define VECTOR_NUMBER_SCI0_TXI ((IRQn_Type) 592) /* SCI0_TXI (SCI0 Transmit data empty) */
        #define VECTOR_NUMBER_SCI0_TEI ((IRQn_Type) 593) /* SCI0_TEI (SCI0 Transmit end) */
        typedef enum IRQn {
            ...
            SCI0_ERI_IRQn = 590, /* SCI0_ERI (SCI0 Receive error) */
            SCI0_RXI_IRQn = 591, /* SCI0_RXI (SCI0 Receive data full) */
            SCI0_TXI_IRQn = 592, /* SCI0_TXI (SCI0 Transmit data empty) */
            SCI0_TEI_IRQn = 593, /* SCI0_TEI (SCI0 Transmit end) */
