...
OPENAMP_RSCTBL_START    = 0xE0000000;
OPENAMP_RSCTBL_LENGTH   = 0x00001000;
INTERCPU_SHM_START      = 0xE0001000;
INTERCPU_SHM_LENGTH     = 0x00001000;
OPENAMP_VRING_START     = 0xE1000000;
OPENAMP_VRING_LENGTH    = 0x08000000;
...
INTERCPU_SHM_START      = DEFINED(INTERCPU_SHM_START) ? INTERCPU_SHM_START : 0;
INTERCPU_SHM_LENGTH     = DEFINED(INTERCPU_SHM_LENGTH) ? INTERCPU_SHM_LENGTH : 0;
...
eSD_eMMC_SPACE_PRV_START  = DEFINED(eSD_eMMC_SPACE_START) ? eSD_eMMC_SPACE_START : 0;
eSD_eMMC_SPACE_PRV_LENGTH = DEFINED(eSD_eMMC_SPACE_LENGTH) ? eSD_eMMC_SPACE_LENGTH : 0;
