...
static inline void metal_list_add_before (struct metal_list * node, struct metal_list * new_node)
{
...
static inline void metal_list_add_after (struct metal_list * node, struct metal_list * new_node)
{
    new_node->prev       = node;
...
static inline void metal_list_add_head (struct metal_list * list, struct metal_list * node)
{
    metal_list_add_after(list, node);
}

static inline void metal_list_add_tail (struct metal_list * list, struct metal_list * node)
{
