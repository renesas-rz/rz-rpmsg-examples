        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [610] = sci_uart_eri_isr, /* SCI5_ERI (SCI5 Receive error) */
            [611] = sci_uart_rxi_isr, /* SCI5_RXI (SCI5 Receive data full) */
            [612] = sci_uart_txi_isr, /* SCI5_TXI (SCI5 Transmit data empty) */
            [613] = sci_uart_tei_isr, /* SCI5_TEI (SCI5 Transmit end) */
        };
        ...
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [610] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI5_ERI), /* SCI5_ERI (SCI5 Receive error) */
            [611] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI5_RXI), /* SCI5_RXI (SCI5 Receive data full) */
            [612] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI5_TXI), /* SCI5_TXI (SCI5 Transmit data empty) */
            [613] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI5_TEI), /* SCI5_TEI (SCI5 Transmit end) */
        };
        #endif
        #endif
