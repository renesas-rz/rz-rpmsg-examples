...
{
    {
        ...
        /* Virtio device entry */
        {
            ...
            },
            {
                ...
                {
                    CFG_VRING0_BASE0_VA, CFG_VRING_ALIGN0, CFG_RPMSG_NUM_BUFS0, 0, 0
                },
                {
                    CFG_VRING1_BASE0_VA, CFG_VRING_ALIGN0, CFG_RPMSG_NUM_BUFS0, 0, 0
                }
            }
        }
#else
    ...
    },
    {
        ...
        /* Virtio device entry */
        {
            ...
            },
            {
                /* Vring rsc entry - part of vdev rsc entry */
                {
                    CFG_VRING0_BASE1_VA, CFG_VRING_ALIGN1, CFG_RPMSG_NUM_BUFS1, 1, 0
                },
                {
                    CFG_VRING1_BASE1_VA, CFG_VRING_ALIGN1, CFG_RPMSG_NUM_BUFS1, 1, 0
                }
            }
        }
#else
...
void init_resource_table (void)
{
    ...
    /* Force accessing to prevent compiler optimize .resource_table section */
    __asm volatile ("" : : "r" (&resources[0]) : "memory");
#endif
}
