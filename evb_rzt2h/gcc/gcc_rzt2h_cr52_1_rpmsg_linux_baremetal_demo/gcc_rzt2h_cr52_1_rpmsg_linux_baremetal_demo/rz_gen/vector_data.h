        ...
        #define VECTOR_NUMBER_INTCPU11 ((IRQn_Type) 11) /* INTCPU11 (Software interrupt 11) */
        #define VECTOR_NUMBER_SCI5_RXI ((IRQn_Type) 384) /* SCI5_RXI (SCI5 Receive data full) */
        #define VECTOR_NUMBER_SCI5_TXI ((IRQn_Type) 385) /* SCI5_TXI (SCI5 Transmit data empty) */
        #define VECTOR_NUMBER_SCI5_TEI ((IRQn_Type) 386) /* SCI5_TEI (SCI5 Transmit end) */
        #define VECTOR_NUMBER_SCI5_ERI ((IRQn_Type) 387) /* SCI5_ERI (SCI5 Receive error) */
        typedef enum IRQn {
            ...
            INTCPU11_IRQn = 11, /* INTCPU11 (Software interrupt 11) */
            SCI5_RXI_IRQn = 384, /* SCI5_RXI (SCI5 Receive data full) */
            SCI5_TXI_IRQn = 385, /* SCI5_TXI (SCI5 Transmit data empty) */
            SCI5_TEI_IRQn = 386, /* SCI5_TEI (SCI5 Transmit end) */
            SCI5_ERI_IRQn = 387, /* SCI5_ERI (SCI5 Receive error) */
