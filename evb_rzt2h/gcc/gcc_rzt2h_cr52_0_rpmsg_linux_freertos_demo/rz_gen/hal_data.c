...
#include "hal_data.h"
icu_inter_cpu_irq_instance_ctrl_t g_icu_inter_cpu_irq10_ctrl;

const icu_inter_cpu_irq_cfg_t g_icu_inter_cpu_irq10_cfg =
{
    .channel             = 10,
    ...
    .p_extend            = NULL,
    .ipl                 = (30),
#if defined(VECTOR_NUMBER_INTCPU10)
    .irq                 = VECTOR_NUMBER_INTCPU10,
#else
    .irq                 = FSP_INVALID_VECTOR,
#endif
};
/* Instance structure to use this module. */
const icu_inter_cpu_irq_instance_t g_icu_inter_cpu_irq10 =
{
    .p_ctrl        = &g_icu_inter_cpu_irq10_ctrl,
    .p_cfg         = &g_icu_inter_cpu_irq10_cfg,
