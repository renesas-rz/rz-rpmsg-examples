...
void new_thread0_entry (void * pvParameters)
{
    ...
    LPRINTF("****************  CR52_0 FreeRTOS  ****************\n", 0);
    LPRINTF("***************************************************\n");

    /* Initialize ICU driver for sw_reset_callback*/
    g_icu_inter_cpu_irq10.p_api->open(g_icu_inter_cpu_irq10.p_ctrl, g_icu_inter_cpu_irq10.p_cfg);
...
/* This function will transfer CR52 CPU0 to WFI state after get software interrupt signal from CA55 */
