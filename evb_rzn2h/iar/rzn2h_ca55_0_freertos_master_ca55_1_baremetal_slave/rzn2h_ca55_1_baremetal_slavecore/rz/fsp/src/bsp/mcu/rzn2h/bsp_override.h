 ...
 * Set NULL as an input parameter to the @ref RZN::cgc_api_t::clockStart function for the PLL clock. */
...
/** Clock configuration structure - Dummy definition because it is not used in this MPU.
 * Set NULL as an input parameter to the @ref RZN::cgc_api_t::clockStart function for the PLL clock. Please refer to the struct st_cgc_pll_cfg. */
