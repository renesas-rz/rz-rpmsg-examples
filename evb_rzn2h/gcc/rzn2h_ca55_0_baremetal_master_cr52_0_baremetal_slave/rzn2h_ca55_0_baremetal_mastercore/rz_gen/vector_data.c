        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [594] = sci_uart_eri_isr, /* SCI1_ERI (SCI1 Receive error) */
            [595] = sci_uart_rxi_isr, /* SCI1_RXI (SCI1 Receive data full) */
            [596] = sci_uart_txi_isr, /* SCI1_TXI (SCI1 Transmit data empty) */
            [597] = sci_uart_tei_isr, /* SCI1_TEI (SCI1 Transmit end) */
        };
        ...
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [594] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI1_ERI), /* SCI1_ERI (SCI1 Receive error) */
            [595] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI1_RXI), /* SCI1_RXI (SCI1 Receive data full) */
            [596] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI1_TXI), /* SCI1_TXI (SCI1 Transmit data empty) */
            [597] = BSP_PRV_CR52_SEL_ENUM(EVENT_SCI1_TEI), /* SCI1_TEI (SCI1 Transmit end) */
        };
        #endif
        #endif
