...
extern const icu_inter_cpu_irq_instance_t g_icu_inter_cpu_irq10;

/** Access the ICU instance using these structures when calling API functions directly (::p_api is not used). */
extern icu_inter_cpu_irq_instance_ctrl_t g_icu_inter_cpu_irq10_ctrl;
extern const icu_inter_cpu_irq_cfg_t g_icu_inter_cpu_irq10_cfg;
